...
__all__ = [
    'DISPID_SRIsUISupported', 'DISPID_SPPName', 'SpeechAllElements',
    'DISPID_SWFEBlockAlign', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRStatus', 'DISPID_SBSWrite', 'SVSFParseAutodetect',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRCEEndStream',
    'ISpeechMMSysAudio', 'SAFT48kHz16BitMono', 'eLEXTYPE_PRIVATE17',
    'DISPID_SLGenerationId', 'SPFM_OPEN_READONLY', 'SVP_17',
    'SAFT8kHz16BitStereo', 'SVEPhoneme', 'ISpObjectToken', 'ISpAudio',
    'DISPID_SRGCmdLoadFromMemory', 'SINoSignal',
    'ISpeechObjectTokenCategory', 'SPPHRASEELEMENT', 'SpFileStream',
    'SpeechPartOfSpeech', 'ISpVoice', 'DISPID_SAStatus',
    'DISPID_SpeechObjectTokens', 'SWPKnownWordPronounceable',
    'ISpResourceManager', 'SVP_16',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_PRIVATE1',
    'SPWT_LEXICAL', 'eLEXTYPE_PRIVATE5',
    'DISPID_SLRemovePronunciation', 'DISPID_SRGCmdSetRuleIdState',
    'SAFTTrueSpeech_8kHz1BitMono', 'SREStreamEnd', 'SpVoice',
    'DISPID_SDKGetBinaryValue', 'SVPOver', 'DISPID_SMSGetData',
    'SPRULE', 'SPXMLRESULTOPTIONS', 'DISPID_SPAStartElementInResult',
    'ISpStream', 'SPSFunction', 'SAFT11kHz16BitMono',
    'SpeechTokenIdUserLexicon', 'DISPID_SVEventInterests',
    ...
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPRsItem',
    'DISPID_SpeechPhraseRule', 'ISpStreamFormat', 'DISPID_SRRTimes',
    'SPEI_RESERVED5', 'SASRun', 'SDTRule', 'SPEI_SR_BOOKMARK',
    'SpeechCategoryAudioIn', 'ISpeechFileStream', 'SPFM_CREATE',
    'SpPhoneConverter', 'SpeechGrammarTagUnlimitedDictation',
    'ISpeechRecognizer', 'SpeechBookmarkOptions', 'ISpDataKey',
    'SpeechRecoEvents', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpPhraseInfoBuilder', 'DISPID_SGRs_NewEnum',
    'Speech_StreamPos_RealTime', 'SPRST_ACTIVE_ALWAYS',
    'STSF_CommonAppData', 'SPPHRASEREPLACEMENT', 'SVEVoiceChange',
    'SP_VISEME_10', 'SRSActiveAlways', 'SREPhraseStart', 'SRSActive',
    'eLEXTYPE_USER', 'SPCATEGORYTYPE', 'DISPID_SPIGrammarId',
    'SPEI_END_INPUT_STREAM', 'SAFT32kHz16BitStereo',
    'DISPID_SASFreeBufferSpace', 'SPSModifier',
    'ISpStreamFormatConverter', 'DISPID_SRCEHypothesis',
    'ISpeechPhraseAlternates', 'DISPID_SpeechObjectToken',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpRecoCategory', 'SPPS_Modifier',
    'DISPID_SOTCreateInstance', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPIDSPTSI_ActiveLength', 'SpeechTokenKeyAttributes',
    'SVSFDefault', 'DISPID_SVSLastBookmark',
    'SpeechRegistryLocalMachineRoot', 'SPRECOGNIZERSTATUS',
    'SpeechVoiceSpeakFlags', 'DISPID_SpeechRecoResult2',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SABufferNotifySize',
    'SAFT11kHz8BitMono', 'SPRS_INACTIVE', 'DISPID_SRRAudio',
    'ISpRecoGrammar2', 'DISPID_SVSPhonemeId', 'ISequentialStream',
    'eLEXTYPE_PRIVATE16', 'SVESentenceBoundary',
    'ISpeechXMLRecoResult', 'SAFT11kHz16BitStereo', 'SPBO_AHEAD',
    'SITooQuiet', 'SAFT22kHz16BitMono', 'DISPID_SPARecoResult',
    'DISPID_SPRuleConfidence', 'SECFIgnoreWidth', 'DISPID_SGRsCommit',
    'eWORDTYPE_DELETED', 'DISPID_SRRSpeakAudio',
    'DISPID_SLWPronunciations', 'SAFT11kHz8BitStereo',
    'DISPID_SRCERecognition', 'SPWF_SRENGINE', 'SP_VISEME_11',
    'SpeechLexiconType', 'SPEI_MIN_SR', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVPriority',
    'SPSERIALIZEDRESULT', 'SAFT8kHz8BitMono', 'SpNullPhoneConverter',
    'SPWF_INPUT', 'eLEXTYPE_RESERVED6', 'SAFT44kHz16BitStereo',
    'DISPID_SASNonBlockingIO', 'SPAR_Unknown', 'SP_VISEME_19',
    'SVSFParseSapi', 'SpeechEngineConfidence',
    'DISPID_SOTGetAttribute', 'SPAO_NONE', 'SDTLexicalForm',
    'SVEStartInputStream', 'DISPID_SDKCreateKey',
    'eLEXTYPE_LETTERTOSOUND', 'SVSFParseMask', 'SP_VISEME_7',
    'SVSFNLPMask', 'DISPID_SABIMinNotification',
    'SPEI_SR_RETAINEDAUDIO', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechPhoneConverter', 'SPSEMANTICERRORINFO',
    'SpStreamFormatConverter', 'SDTAudio', 'DISPID_SWFEBitsPerSample',
    'SPVPRI_NORMAL', 'SPCT_SUB_DICTATION', 'DISPID_SRProfile',
    'SpPhoneticAlphabetConverter', 'SAFT22kHz8BitMono',
    'DISPID_SRGCmdSetRuleState', 'SPEI_MAX_SR',
    'SGDSActiveUserDelimited', 'SVP_20', 'SpeechFormatType',
    'DISPID_SLPSymbolic', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRCEAdaptation', 'SGLexicalNoSpecialChars',
    'DISPID_SPEPronunciation', 'SPAO_RETAIN_AUDIO',
    'SpeechGrammarState', 'SpeechTokenShellFolder',
    'DISPID_SPRules_NewEnum', 'SVSFIsNotXML', 'SVP_14',
    'SAFT48kHz8BitMono', 'DISPID_SRCRecognizer',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechRuleState', 'SRCS_Enabled',
    'DISPID_SDKDeleteKey', 'SPRECOSTATE', 'SAFT24kHz8BitStereo',
    'SAFTADPCM_44kHzMono', 'SPCS_ENABLED', 'SPSHT_EMAIL',
    'DISPID_SGRClear', 'SPAS_STOP', 'DISPID_SPPChildren',
    'DISPID_SPELexicalForm', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPRsCount', 'SPVISEMES', 'DISPID_SRCState',
    'SVEAllEvents', 'DISPID_SGRAddResource', 'SPGRAMMARSTATE',
    'DISPID_SPRs_NewEnum', 'SpeechUserTraining', 'SpeechAudioState',
    'DISPID_SMSADeviceId', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SSSPTRelativeToCurrentPosition', 'SpeechTokenValueCLSID',
    'SRAORetainAudio', 'SPSLMA', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRCVoice', 'DISPID_SPCIdToPhone', 'eLEXTYPE_RESERVED8',
    'SSTTDictation', 'SVSFParseSsml', 'ISpeechPhoneConverter',
    'DISPID_SPIReplacements', 'DISPID_SLPs_NewEnum',
    'DISPID_SRGetPropertyString', 'DISPID_SFSOpen',
    'DISPID_SGRSTRule', 'SSTTWildcard', 'DISPID_SRCEFalseRecognition',
    'SPEI_START_INPUT_STREAM', 'SPCT_DICTATION', 'DISPID_SLPsItem',
    'SVP_19', 'eLEXTYPE_PRIVATE20', 'SpeechDisplayAttributes',
    'DISPID_SpeechVoice', 'DISPID_SpeechPhraseElement', 'SPAS_RUN',
    'DISPID_SOTDataKey', 'SPRS_ACTIVE', 'SVEAudioLevel',
    'SP_VISEME_2', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'IEnumString',
    'SRTExtendableParse', 'SAFT8kHz8BitStereo', 'DISPID_SpeechAudio',
    'DISPID_SBSRead', 'SPEI_SENTENCE_BOUNDARY', 'SpWaveFormatEx',
    'DISPID_SpeechPhraseReplacements', 'SPSNotOverriden',
    'SpeechDataKeyLocation', 'SGRSTTWord', 'SREFalseRecognition',
    'eWORDTYPE_ADDED', 'SVPNormal', 'SREBookmark', 'SPRST_NUM_STATES',
    'SpResourceManager', 'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE14',
    'DISPID_SVGetVoices', 'ISpPhoneticAlphabetSelection', 'SVP_4',
    'DISPID_SVGetAudioInputs',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPWORDTYPE',
    'SPPS_Noncontent', 'ISpeechLexicon', 'ISpShortcut',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRGSetWordSequenceData',
    'SPFM_OPEN_READWRITE', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPRuleEngineConfidence', 'SDTAlternates',
    'DISPID_SAEventHandle', 'eLEXTYPE_PRIVATE9', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRDisplayUI', 'SRAONone', 'tagSPTEXTSELECTIONINFO',
    'SAFTGSM610_8kHzMono', 'ISpeechDataKey', 'SRARoot',
    'DISPID_SRRTStreamTime', 'ISpProperties', 'SpeechVoicePriority',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRCResume',
    'SVSFUnusedFlags', 'SAFTGSM610_44kHzMono',
    'DISPID_SVWaitUntilDone', 'DISPID_SOTsItem',
    'IInternetSecurityMgrSite', 'SPAR_Low', 'SPEI_WORD_BOUNDARY',
    'SDKLCurrentConfig', 'SpeechAudioFormatGUIDWave', 'SVF_Emphasis',
    'DISPID_SPRDisplayAttributes', 'SPSEMANTICFORMAT',
    'DISPID_SPRuleFirstElement', 'SAFTCCITT_uLaw_44kHzStereo',
    'SAFTADPCM_22kHzStereo', 'SPVPRI_ALERT', 'SPEI_INTERFERENCE',
    'ISpeechBaseStream', 'DISPID_SVAudioOutputStream',
    'DISPID_SRState', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVSInputSentencePosition', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPIProperties', 'DISPID_SPAs_NewEnum',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPPEngineConfidence',
    'eLEXTYPE_PRIVATE19', 'DISPID_SAVolume', 'DISPID_SVStatus',
    'DISPID_SGRsAdd', 'SRAExport', 'SPEI_HYPOTHESIS',
    'DISPID_SOTRemove', 'SPEI_RECO_STATE_CHANGE', 'SPPS_LMA',
    'DISPID_SLWs_NewEnum', 'Speech_Max_Pron_Length',
    'SPBO_TIME_UNITS', 'SpeechCategoryAppLexicons',
    'DISPID_SPPNumberOfElements', 'DISPID_SWFEFormatTag', 'SVP_12',
    'SpeechRecoContextState', 'SSFMOpenReadWrite', 'SVP_11', 'SVP_13',
    'DISPID_SASCurrentDevicePosition', 'SP_VISEME_14',
    'DISPID_SpeechPhraseProperties', 'tagSPPROPERTYINFO', 'UINT_PTR',
    'SAFTNonStandardFormat', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPPsCount', 'SAFTCCITT_ALaw_11kHzMono',
    'SPINTERFERENCE_NOSIGNAL', 'SREHypothesis', 'ISpeechCustomStream',
    'DISPID_SVSpeak', 'DISPID_SpeechDataKey', 'DISPID_SGRSTType',
    'eLEXTYPE_PRIVATE4', 'DISPID_SpeechObjectTokenCategory',
    'SPEI_RESERVED6', 'SPWT_PRONUNCIATION',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRAImport',
    'SpeechRetainedAudioOptions', 'SP_VISEME_5', 'SLTApp',
    'SPVOICESTATUS', 'DISPID_SGRsItem', 'DISPID_SCSBaseStream',
    'SPPS_Function', 'DISPID_SRCRetainedAudio',
    'SAFTNoAssignedFormat', 'SP_VISEME_21', 'DISPID_SPAsCount',
    'SpShortcut', 'ISpeechRecoGrammar', 'SVP_5',
    'DISPID_SABufferInfo', 'ISpeechLexiconPronunciations',
    'DISPID_SVSkip', 'SDA_Consume_Leading_Spaces',
    'eLEXTYPE_PRIVATE7', 'DISPID_SOTId', 'ISpeechAudioStatus',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SDKSetLongValue',
    'DISPID_SRCERecognitionForOtherContext', 'ISpRecoResult',
    'Speech_Default_Weight', 'SRTReSent', 'DISPID_SPISaveToMemory',
    'SDTReplacement', 'SpObjectTokenCategory', 'SpeechTokenKeyFiles',
    'DISPID_SRCCreateResultFromMemory', '_SPAUDIOSTATE', 'SVEViseme',
    'DISPID_SVDisplayUI', 'eLEXTYPE_PRIVATE8',
    'DISPID_SVSLastStreamNumberQueued', 'SPGRAMMARWORDTYPE',
    'DISPID_SRGRules', 'ISpeechRecoResult', 'SPGS_DISABLED',
    'ISpeechAudio', 'DISPIDSPTSI_SelectionOffset', 'SPPS_RESERVED4',
    'SPCT_COMMAND', 'DISPID_SVEPhoneme', 'DISPID_SGRSTsItem',
    'SVEWordBoundary', 'SPADAPTATIONRELEVANCE', 'SPEI_ADAPTATION',
    'DISPID_SVEVoiceChange', 'SGRSTTRule', 'DISPID_SABIEventBias',
    'DISPID_SVSpeakCompleteEvent', 'SVP_8', 'DISPID_SVRate',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRRecognizer',
    'SpeechStreamSeekPositionType', 'Speech_StreamPos_Asap',
    'SREAdaptation', 'SpeechDiscardType', 'SVSFPersistXML',
    'SpeechPropertyNormalConfidenceThreshold',
    'SPINTERFERENCE_LATENCY_WARNING', 'SREAudioLevel', 'SLOStatic',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRGState', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPCONTEXTSTATE', 'DISPID_SPRuleName', 'SPRST_ACTIVE',
    'ISpPhoneticAlphabetConverter', 'STCRemoteServer',
    'DISPID_SPIGetText', 'SpeechEngineProperties', 'SBONone',
    'SGDSActiveWithAutoPause', 'DISPID_SRGIsPronounceable',
    'SASClosed', 'SpeechGrammarTagDictation', 'SINoise',
    'SP_VISEME_12', 'DISPID_SVSInputSentenceLength',
    'DISPID_SPRuleChildren', 'DISPID_SpeechXMLRecoResult',
    'SGRSTTEpsilon', 'SPSNoun', 'ISpeechPhraseAlternate',
    'DISPID_SPIEngineId', 'DISPID_SpeechPhraseRules',
    'SPFM_CREATE_ALWAYS', 'SPEI_PHRASE_START', 'SPINTERFERENCE_NONE',
    'DISPID_SFSClose', 'DISPID_SpeechVoiceEvent',
    'DISPID_SVIsUISupported', 'ISpeechPhraseInfoBuilder',
    'SpInprocRecognizer', 'DISPID_SPEAudioTimeOffset',
    'SpeechTokenKeyUI', 'DISPID_SRCBookmark', 'DISPID_SPCLangId',
    'SRSEDone', 'DISPID_SGRsFindRule', 'SRTAutopause',
    'SpeechPropertyComplexResponseSpeed', 'SAFT48kHz8BitStereo',
    'STCAll', 'DISPID_SPRText', 'SPEI_MAX_TTS',
    'DISPID_SRGDictationSetState', 'SPSMF_UPS',
    'DISPID_SpeechRecognizer', 'SLTUser', 'SPEI_SR_AUDIO_LEVEL',
    'SP_VISEME_20', 'WAVEFORMATEX', 'SpeechStreamFileMode',
    'SpNotifyTranslator', 'SpeechSpecialTransitionType',
    'DISPID_SADefaultFormat', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SGRSTPropertyValue',
    'SPDKL_LocalMachine', 'SPPS_Unknown', 'SWTDeleted', 'SP_VISEME_4',
    'SPXRO_SML', 'SPPS_Interjection', 'DISPID_SVSVisemeId',
    'SAFTADPCM_44kHzStereo', 'SGRSTTDictation',
    'DISPID_SpeechPhraseReplacement', 'SVSFNLPSpeakPunc',
    'DISPID_SRRRecoContext', 'SpeechWordPronounceable',
    'DISPID_SGRSTNextState', 'ISpNotifyTranslator', 'SPPHRASERULE',
    'SPSSuppressWord', 'DISPID_SpeechRecoContextEvents',
    'eLEXTYPE_PRIVATE18', 'STCInprocHandler', 'SECFIgnoreKanaType',
    'SREStreamStart', 'SAFT12kHz8BitStereo',
    'DISPID_SPEAudioSizeTime', 'SGDSActive',
    'SpeechCategoryPhoneConverters', 'ISpGrammarBuilder', 'IStream',
    'SPPS_SuppressWord', 'ISpeechPhraseProperties', 'SSTTTextBuffer',
    'ISpNotifySource', 'SPTEXTSELECTIONINFO',
    'DISPID_SRRSetTextFeedback', 'SAFTCCITT_uLaw_8kHzMono',
    'SPCS_DISABLED', 'DISPID_SMSAMMHandle', 'DISPID_SVEBookmark',
    'SPAR_High', 'SPPS_RESERVED3', 'SpeechRegistryUserRoot',
    'SAFTGSM610_22kHzMono', 'SDKLDefaultLocation',
    'DISPID_SLGetPronunciations', 'SVP_18', 'SPWORD',
    'DISPID_SAFSetWaveFormatEx', 'SDA_One_Trailing_Space',
    'SRAInterpreter', 'SVP_9', 'ISpXMLRecoResult', 'SPWORDLIST',
    'Speech_Max_Word_Length', 'SP_VISEME_6',
    'IInternetSecurityManager', 'SGRSTTTextBuffer', 'ISpRecoContext',
    'SVF_None', 'DISPID_SLWLangId', 'SGSEnabled', 'SpeechAudioVolume',
    'eLEXTYPE_VENDORLEXICON', 'SVSFVoiceMask',
    'DISPID_SRGCmdLoadFromObject', 'SPPS_NotOverriden',
    'SGSExclusive', 'DISPID_SRGCommit', 'SSFMCreate',
    'DISPID_SRCEBookmark', 'DISPID_SPEAudioSizeBytes',
    'eLEXTYPE_RESERVED4', 'tagSTATSTG', 'SITooLoud', 'DISPID_SRGId',
    'DISPID_SRSetPropertyString', 'DISPID_SWFEExtraData',
    'SP_VISEME_1', 'DISPID_SLAddPronunciation',
    'DISPID_SRCEventInterests', 'SPBOOKMARKOPTIONS',
    'eLEXTYPE_PRIVATE11', 'eLEXTYPE_USER_SHORTCUT',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRRAudioFormat',
    'SPEI_SOUND_START', 'DISPID_SRCCreateGrammar', 'SECFDefault',
    'SpeechCategoryVoices', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRCRetainedAudioFormat', 'SPRECORESULTTIMES',
    'DISPID_SpeechLexiconWord', 'SPAR_Medium',
    'DISPID_SDKSetStringValue', 'SpeechRecoProfileProperties',
    'SPLOADOPTIONS', 'SPSInterjection', 'DISPID_SOTDisplayUI',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SVEStreamEnd',
    'SPSTREAMFORMATTYPE', 'SPPS_RESERVED1', 'SVSFlagsAsync',
    'ISpeechTextSelectionInformation', 'STSF_LocalAppData',
    'DISPID_SLWsItem', 'SPEI_RESERVED3', 'DISPID_SPIAudioSizeTime',
    'SpeechMicTraining', 'DISPID_SpeechFileStream',
    'eLEXTYPE_PRIVATE3', 'SAFT22kHz8BitStereo', 'SP_VISEME_8',
    'SPPS_Verb', 'DISPID_SGRSTWeight', 'SAFTADPCM_11kHzMono',
    'ISpPhrase', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SGRInitialState', 'SGDisplay', 'DISPID_SpeechAudioStatus',
    'SpAudioFormat', 'eLEXTYPE_PRIVATE6', 'SRTStandard',
    'DISPID_SPPConfidence', 'SPWT_DISPLAY',
    'DISPID_SLGetGenerationChange', 'SpeechAudioFormatType',
    'SAFT22kHz16BitStereo', 'DISPIDSPTSI', 'SpCompressedLexicon',
    'SRESoundEnd', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechRecoResult', 'DISPID_SGRId', 'DISPID_SAFType',
    'SAFT16kHz8BitStereo', 'SpeechAudioFormatGUIDText',
    'SAFT48kHz16BitStereo', 'SpCustomStream', 'SVP_15',
    'SGDSInactive', 'SPFM_NUM_MODES', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechPhraseInfo',
    'ISpeechPhraseReplacements', 'SPAS_PAUSE', 'SECFIgnoreCase',
    'eLEXTYPE_RESERVED7', 'SVP_1', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SOTs_NewEnum', 'SPLO_DYNAMIC',
    'DISPID_SRSSupportedLanguages', 'DISPID_SDKDeleteValue',
    'ISpObjectTokenCategory', 'SpStream', 'SPDKL_DefaultLocation',
    'DISPID_SOTGetStorageFileName', 'DISPID_SVVoice',
    '__MIDL_IWinTypes_0009', 'SSSPTRelativeToEnd', 'SVP_3',
    'DISPID_SPEsCount', 'DISPID_SPRuleParent',
    'SpeechCategoryAudioOut', 'SAFTADPCM_8kHzMono', 'SVF_Stressed',
    'SASStop', 'SVP_2', 'SPLEXICONTYPE', 'SREPropertyNumChange',
    'DISPID_SPPValue', 'SAFT16kHz16BitStereo',
    'DISPID_SAFGetWaveFormatEx', 'SPWORDPRONUNCIATION',
    'DISPID_SPCPhoneToId', 'SFTSREngine', 'SPBO_NONE',
    'DISPID_SVEEnginePrivate', 'DISPID_SDKEnumKeys',
    'DISPID_SVEStreamStart', 'DISPID_SMSSetData',
    'DISPID_SpeechGrammarRuleState', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPIDSPTSI_ActiveOffset', 'SPWORDPRONUNCIATIONLIST',
    'ISpObjectWithToken', 'DISPID_SPPBRestorePhraseFromMemory',
    ...
    'SGLexical', 'SpeechPropertyAdaptationOn',
    'DISPID_SGRSTransitions', 'SITooFast', 'DISPID_SPILanguageId',
    'SpeechGrammarRuleStateTransitionType', 'SPSUnknown',
    'ISpeechWaveFormatEx', 'DISPID_SBSSeek',
    'DISPID_SRCEInterference', 'eLEXTYPE_RESERVED9',
    'DISPID_SGRsCommitAndSave', 'SpMemoryStream',
    'SpeechEmulationCompareFlags', 'DISPID_SRCEPropertyStringChange',
    'SREAllEvents', 'DISPID_SVEAudioLevel',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRIsShared',
    'DISPID_SRCEStartStream', 'SPRULESTATE', 'DISPID_SRCPause',
    'DISPID_SPRuleId', 'SVEEndInputStream',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SASetState',
    'ISpeechGrammarRule', 'SpeechGrammarTagWildcard',
    'DISPID_SDKGetStringValue', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPEDisplayText', 'DISPID_SRGRecoContext',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRGReset', 'SPSHT_OTHER',
    'DISPID_SPEsItem', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SLGetWords', 'ISpeechRecoContext',
    'SWPUnknownWordPronounceable', 'SVP_6',
    'SpeechCategoryRecognizers', 'DISPID_SVPause', 'SPCT_SLEEP',
    'SDTDisplayText', 'SWTAdded', 'SGRSTTWildcard',
    'SPINTERFERENCE_NOISE', 'SPAUDIOSTATE', 'DISPID_SLPPhoneIds',
    'DISPID_SOTCEnumerateTokens', 'SAFT16kHz8BitMono',
    'STSF_FlagCreate', 'DISPID_SOTCategory', 'SPDKL_CurrentConfig',
    'DISPID_SVSInputWordLength', 'SpMMAudioIn',
    'ISpeechRecoResultTimes', 'SPVPRIORITY', 'DISPID_SRAudioInput',
    'SECNormalConfidence', 'SAFT32kHz8BitMono', 'STCInprocServer',
    'DISPID_SPPId', 'DISPID_SPERequiredConfidence',
    'DISPID_SVSyncronousSpeakTimeout', 'SP_VISEME_16',
    'SECLowConfidence', 'STSF_AppData', 'SAFT32kHz16BitMono',
    'SP_VISEME_13', 'SPEI_SR_PRIVATE', 'DISPID_SLPType',
    'DISPID_SPEEngineConfidence', 'DISPID_SPRFirstElement',
    'ISpNotifySink', 'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_18',
    'SVP_7', 'DISPID_SVSLastResult', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPEActualConfidence', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLWWord', 'SVEPrivate', 'SAFT8kHz16BitMono',
    'DISPID_SPRulesCount', 'DISPID_SpeechLexiconWords',
    'SAFT12kHz16BitMono', 'SAFTADPCM_11kHzStereo',
    'ISpeechPhraseInfo', 'ISpeechResourceLoader', 'SPAUDIOOPTIONS',
    'SPDKL_CurrentUser', '_RemotableHandle', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechRecoResultTimes', 'SpSharedRecognizer',
    'SAFTDefault', 'SPEI_VOICE_CHANGE', 'ISpEventSink',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SLWType',
    'SpLexicon', 'DISPIDSPRG', 'DISPID_SGRSAddSpecialTransition',
    'SPBO_PAUSE', 'SPGS_ENABLED', 'DISPID_SRGetFormat',
    'DISPID_SOTIsUISupported', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_SOUND_END', 'DISPID_SVAudioOutput',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SOTSetId',
    'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_PRIVATE12',
    'DISPID_SABIBufferSize', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SLPLangId', 'DISPID_SDKGetlongValue',
    'SPINTERFERENCE_TOOLOUD', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFT24kHz16BitStereo', 'SpeechInterference',
    'ISpeechObjectTokens', 'ISpeechRecoResult2',
    'SpeechRecognitionType', 'ISpeechAudioFormat',
    'SRERecoOtherContext', 'SPEI_VISEME',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpRecognizer',
    'ISpeechGrammarRuleStateTransitions', 'SP_VISEME_9',
    'DISPID_SVGetProfiles', 'DISPID_SGRSTs_NewEnum',
    'SpSharedRecoContext', 'SPEI_END_SR_STREAM',
    'ISpeechPhraseReplacement', 'ISpPhraseAlt',
    'ISpeechAudioBufferInfo', 'SPEI_PHONEME', 'ISpLexicon',
    'SVSFIsFilename', 'eLEXTYPE_PRIVATE15', '_ISpeechVoiceEvents',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechLexiconPronunciation',
    'DISPID_SVSCurrentStreamNumber', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SLPPartOfSpeech', 'DISPID_SVSpeakStream', 'SPAUDIOSTATUS',
    'DISPID_SGRName', 'SRERecognition',
    'DISPID_SPIAudioStreamPosition', 'SAFT24kHz16BitMono',
    'DISPID_SVVolume', 'DISPID_SVESentenceBoundary',
    'DISPID_SRSClsidEngine', 'ISpeechVoiceStatus', 'SRCS_Disabled',
    'ISpRecognizer2', 'DISPID_SPERetainedStreamOffset',
    'SpeechPropertyResourceUsage', 'DISPID_SDKSetBinaryValue',
    'SGSDisabled', 'DISPID_SPPs_NewEnum', 'SVP_0',
    'SPXRO_Alternates_SML', 'SpeechAddRemoveWord',
    'DISPID_SGRSTsCount', 'ISpeechPhraseElements',
    'DISPID_SRCCmdMaxAlternates', 'SECFEmulateResult',
    'DISPID_SOTCDefault', 'SPSHT_NotOverriden',
    'DISPID_SVSInputWordPosition', 'DISPID_SpeechRecognizerStatus',
    'SpUnCompressedLexicon', 'DISPID_SRRTLength', 'DISPID_SGRSRule',
    'SPLO_STATIC', 'eLEXTYPE_APP', 'DISPID_SPRNumberOfElements',
    'SpeechRecognizerState', 'SpTextSelectionInformation',
    'DISPID_SRCreateRecoContext', 'SRSEIsSpeaking', 'SPSHORTCUTPAIR',
    'SpMMAudioOut', 'DISPID_SASState', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SOTCSetId', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPGS_EXCLUSIVE', 'DISPID_SRCESoundEnd', 'SAFT16kHz16BitMono',
    'SAFT44kHz8BitMono', 'SAFTGSM610_11kHzMono', 'SPEI_TTS_PRIVATE',
    'SRATopLevel', 'SRTEmulated', 'ISpeechLexiconWord',
    'SPPHRASEPROPERTY', 'SPFILEMODE', 'SPBINARYGRAMMAR',
    'DISPID_SPIElements', 'DISPID_SVEViseme', 'SAFT44kHz16BitMono',
    ...
    'DISPID_SBSFormat', 'SINone', 'SpeechVoiceEvents',
    'SpeechRunState', 'SPPROPERTYINFO', 'SPSVerb', 'DISPID_SOTCId',
    'LONG_PTR', 'DISPID_SAFGuid', 'SASPause', 'DISPID_SRCESoundStart',
    'SSSPTRelativeToStart', 'ISpSerializeState',
    'SAFTExtendedAudioFormat', 'SPSHT_Unknown', 'ISpMMSysAudio',
    'SAFT32kHz8BitStereo', 'SREPrivate', 'DISPID_SVEWord',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechLexicon',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechGrammarRuleState',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SpeechRecoContext',
    'DISPID_SRCEPhraseStart', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRRGetXMLResult', 'STCLocalServer',
    'SPEI_RECO_OTHER_CONTEXT', 'SPINTERFERENCE',
    'DISPID_SRCEAudioLevel', 'DISPID_SRRTTickCount',
    'DISPID_SVSRunningState', 'SpObjectToken', 'SRSInactive',
    'SPPS_RESERVED2', 'SpInProcRecoContext', 'SRADefaultToActive',
    'SPDATAKEYLOCATION', 'DISPID_SRSNumberOfActiveRules',
    'SPEI_RESERVED1', 'SAFT44kHz8BitStereo', 'DISPID_SOTsCount',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SpeechCustomStream',
    '_ISpeechRecoContextEvents', 'ISpRecoContext2',
    'SpeechAudioProperties', 'SPRST_INACTIVE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVP_21',
    'DISPID_SGRAttributes', 'DISPID_SGRsDynamic', 'SITooSlow',
    'SPEVENT', 'SLODynamic', 'DISPID_SpeechMemoryStream',
    'DISPID_SOTCGetDataKey', 'ISpeechGrammarRules',
    'DISPID_SpeechGrammarRule', 'SPSHORTCUTTYPE', 'SPEI_RECOGNITION',
    'DISPID_SPAsItem', 'DISPID_SPPsItem',
    'DISPID_SPEDisplayAttributes', 'SPRECOCONTEXTSTATUS',
    'DISPID_SLAddPronunciationByPhoneIds', 'eLEXTYPE_RESERVED10',
    'SECHighConfidence', 'SP_VISEME_17', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpeechLexiconWords', 'SGPronounciation', 'SRADynamic',
    'DISPID_SpeechLexiconProns',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SREStateChange',
    'IEnumSpObjectTokens', 'SPAS_CLOSED', 'SDTAll', 'SAFTText',
    'DISPID_SMSALineId', 'DISPID_SPRulesItem', 'SPEVENTENUM',
    'DISPID_SLPsCount', 'DISPID_SRGetRecognizers',
    'SECFNoSpecialChars', 'SPINTERFERENCE_TOOQUIET',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPPFirstElement',
    'DISPID_SRGDictationLoad', 'ISpeechRecognizerStatus',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRsCount',
    'eLEXTYPE_PRIVATE10', 'SSFMCreateForWrite', 'SpeechWordType',
    'SAFTCCITT_ALaw_8kHzMono', 'SDTProperty', 'DISPID_SPAPhraseInfo',
    'SPSERIALIZEDPHRASE', 'SDKLCurrentUser',
    'DISPID_SpeechBaseStream', 'DISPID_SRRPhraseInfo',
    'SpeechRuleAttributes', 'ISpRecognizer3', 'DISPID_SPACommit',
    'SVSFIsXML', 'SPEI_REQUEST_UI', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPPS_Noun', 'DISPID_SRRSaveToMemory', 'DISPID_SPIRule',
    'SDTPronunciation', 'SpeechGrammarWordType',
    'DISPID_SpeechAudioFormat', 'DISPID_SGRSTPropertyId',
    'SDA_No_Trailing_Space', 'DISPID_SRAudioInputStream',
    'DISPID_SRGDictationUnload', 'ISpeechVoice',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpeechObjectToken',
    'SDKLLocalMachine', 'ISpeechPhraseProperty',
    'SAFT12kHz16BitStereo', 'DISPID_SLWsCount', 'DISPID_SGRSTText',
    'DISPID_SPRuleNumberOfElements', 'SAFT12kHz8BitMono',
    'SpeechLoadOption', 'SpeechVisemeFeature', 'SP_VISEME_0',
    'SpMMAudioEnum', 'SPAUDIOBUFFERINFO', 'SRTSMLTimeout',
    'SREInterference', 'ISpEventSource', 'SpeechTokenContext',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechPhraseElements',
    'ISpeechGrammarRuleStateTransition', 'SRERequestUI',
    'SPVPRI_OVER', 'DISPID_SVAlertBoundary', 'SPEI_RESERVED2',
    'SVPAlert', 'DISPID_SVResume', 'DISPID_SRSCurrentStreamPosition',
    'SPEI_UNDEFINED', 'SP_VISEME_3', 'DISPID_SPIStartTime',
    'SPEI_TTS_BOOKMARK', 'DISPID_SGRAddState',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPPARTOFSPEECH', 'SPPHRASE',
    'SAFT24kHz8BitMono', 'DISPID_SDKOpenKey',
    'DISPID_SGRSTPropertyName', 'DISPID_SRRGetXMLErrorInfo',
    'SRSInactiveWithPurge', 'SBOPause', 'DISPID_SRGSetTextSelection',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPEs_NewEnum',
    'DISPID_SRCERequestUI', 'SAFTCCITT_ALaw_22kHzStereo',
    'SVEBookmark', 'DISPID_SOTGetDescription', 'SVP_10',
    'SRESoundStart', 'SPINTERFERENCE_TOOSLOW', 'SP_VISEME_15',
    'SPEVENTSOURCEINFO', 'DISPID_SPIRetainedSizeBytes',
    'SpeechDictationTopicSpelling', 'DISPID_SPIAudioSizeBytes',
    'SpeechPropertyResponseSpeed', 'DISPID_SRRAlternates',
    'DISPID_SPPParent', 'ISpeechRecoResultDispatch',
    'DISPID_SWFEChannels', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SpeechPhraseAlternate', 'SPCT_SUB_COMMAND',
    'SPEI_MIN_TTS', 'DISPID_SVGetAudioOutputs', 'SpeechVisemeType',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechMemoryStream',
    'DISPID_SDKEnumValues', 'ISpeechPhraseRules',
    'ISpeechPhraseElement'
]

_check_version('1.1.14', 1652417358.494828)
