...
__all__ = [
    'DISPID_SLWsItem', 'ISpStream', 'SPAO_NONE',
    'SAFT48kHz8BitStereo', 'DISPID_SPPNumberOfElements',
    'SDA_Consume_Leading_Spaces', 'SVEPhoneme', 'SITooSlow',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpeechWordType',
    'DISPID_SWFEFormatTag', 'DISPID_SPEAudioTimeOffset',
    'SP_VISEME_16', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRRTLength', 'DISPID_SpeechPhraseInfo',
    'SVEEndInputStream', 'SpMMAudioOut', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRGIsPronounceable',
    'SpeechGrammarRuleStateTransitionType',
    'SpeechPropertyResourceUsage', 'SPEI_TTS_BOOKMARK',
    'SPSERIALIZEDPHRASE', 'SPWT_LEXICAL', 'ISpeechPhraseReplacement',
    'SPPS_RESERVED2', 'ISpSerializeState', 'SpeechTokenKeyFiles',
    'SPWORDPRONUNCIATIONLIST', 'SWPUnknownWordPronounceable',
    'SPPS_LMA', 'DISPID_SRProfile', 'DISPID_SGRSTType',
    'SpInprocRecognizer', 'SRAInterpreter', 'SVP_9',
    'SGRSTTDictation', 'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SGRsCount',
    'SPAR_Low', 'DISPID_SPEAudioSizeBytes', 'DISPID_SGRsDynamic',
    'DISPID_SRGRules', 'SECHighConfidence',
    'DISPID_SRCEPropertyStringChange', 'ISpeechLexicon',
    'DISPID_SLRemovePronunciation', 'SpeechAddRemoveWord',
    'DISPID_SVGetAudioInputs', 'DISPID_SPIGetDisplayAttributes',
    'ISpRecoCategory', 'DISPID_SPAStartElementInResult',
    'DISPID_SGRs_NewEnum', 'DISPID_SRSSupportedLanguages',
    'DISPID_SDKSetLongValue', 'DISPID_SPPParent',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechPhraseElements', 'SPEVENTSOURCEINFO',
    'DISPID_SLWPronunciations', 'ISpNotifyTranslator',
    'eWORDTYPE_DELETED', 'ISpeechPhraseAlternate',
    'DISPID_SpeechObjectToken', 'SGRSTTRule', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRSetPropertyString', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPSERIALIZEDRESULT', 'DISPID_SRSAudioStatus', 'SPWORD',
    'SREStreamStart', 'SAFT11kHz8BitMono', 'SPINTERFERENCE_TOOQUIET',
    'SRSEDone', 'SDTPronunciation', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpEventSource', 'DISPID_SDKSetBinaryValue', 'ISpPhrase',
    'ISpRecognizer', 'ISpeechLexiconWord', 'SVP_4',
    'SAFT11kHz16BitStereo', 'DISPID_SOTCEnumerateTokens',
    'ISpRecognizer2', 'SINoise', 'DISPID_SLGenerationId',
    'DISPID_SLPsCount', 'SpeechTokenContext', 'DISPID_SRRRecoContext',
    'DISPID_SpeechAudioStatus', 'IEnumSpObjectTokens',
    'ISpeechRecoResult2', 'DISPID_SRCEAudioLevel',
    'SAFT24kHz8BitStereo', 'eLEXTYPE_USER_SHORTCUT', 'SFTSREngine',
    'DISPID_SPRNumberOfElements', 'DISPID_SLGetGenerationChange',
    'SVEWordBoundary', 'ISpEventSink', 'SRTAutopause',
    'DISPID_SRCEFalseRecognition', 'SPRST_INACTIVE',
    'DISPID_SGRSTPropertyName', 'SPVOICESTATUS', 'DISPID_SPPValue',
    'DISPID_SGRSTRule', 'SPRULESTATE', 'DISPID_SpeechVoiceStatus',
    'SPPS_Noun', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPINTERFERENCE_NOSIGNAL', 'SPVISEMES', 'eLEXTYPE_PRIVATE6',
    'SGPronounciation', 'DISPID_SDKEnumKeys', 'SRAORetainAudio',
    'DISPID_SGRId', 'DISPID_SGRClear', 'DISPID_SFSClose',
    'DISPID_SGRAddResource', 'DISPID_SPPId',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVResume',
    'SPADAPTATIONRELEVANCE', 'DISPIDSPTSI_ActiveLength',
    'SPEI_RESERVED6', 'SGDisplay', 'SSTTWildcard', 'ISpVoice',
    'DISPID_SLGetPronunciations', 'SPEVENTENUM',
    'DISPID_SPISaveToMemory', 'SSSPTRelativeToStart', 'SWTDeleted',
    'ISpeechPhraseProperties', 'SAFTGSM610_22kHzMono', 'SINone',
    'DISPID_SRRTimes', 'SVSFPurgeBeforeSpeak', 'ISpeechGrammarRule',
    'SPEI_MIN_SR', 'SpInProcRecoContext', 'DISPID_SASNonBlockingIO',
    'DISPID_SASState', 'SPWF_INPUT', 'DISPID_SpeechRecoResult',
    'DISPIDSPTSI', 'tagSTATSTG', 'SpPhoneticAlphabetConverter',
    'SVP_20', 'SRTEmulated', 'SVP_7', 'SECFIgnoreKanaType',
    'DISPID_SVAudioOutputStream', 'SVSFlagsAsync',
    'SpUnCompressedLexicon', 'SpResourceManager', 'SPWORDTYPE',
    'SPRULE', 'SPCT_SLEEP', 'DISPID_SPEsItem', 'SDTAll',
    'SPPS_Interjection', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPCPhoneToId', 'DISPID_SRRDiscardResultInfo',
    'SECFEmulateResult', 'ISpAudio', 'SPEI_RECO_STATE_CHANGE',
    'SVEStartInputStream', 'ISpeechGrammarRuleState', 'SPRS_INACTIVE',
    'DISPID_SVSyncronousSpeakTimeout', 'SPSLMA', 'DISPID_SBSWrite',
    'DISPID_SRGCommit', 'DISPID_SVEViseme', 'SRESoundStart',
    'DISPID_SVDisplayUI', 'SRERequestUI', 'SPEI_SR_AUDIO_LEVEL',
    'SVP_1', 'SVSFDefault', 'SPLEXICONTYPE',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SOTRemove', 'SVPAlert',
    'SAFTADPCM_11kHzStereo', 'ISpeechPhraseRule',
    'DISPID_SpeechPhraseElement', 'DISPID_SRIsUISupported',
    'SPPS_Modifier', 'SVEPrivate', 'DISPID_SPIEngineId',
    'SPEI_RESERVED5', 'DISPID_SVRate', 'DISPID_SRSetPropertyNumber',
    'SRTSMLTimeout', 'ISpRecoGrammar', 'SPBO_AHEAD',
    'eLEXTYPE_PRIVATE4', 'SPEI_RESERVED3', 'eLEXTYPE_PRIVATE20',
    'SpeechDataKeyLocation', 'DISPID_SAFGetWaveFormatEx',
    'SPINTERFERENCE_TOOFAST', 'SpeechAudioFormatGUIDText',
    'SPAUDIOSTATUS', 'SPPS_Verb', 'ISpeechPhraseReplacements',
    'SPPARTOFSPEECH', 'DISPID_SRCEventInterests',
    'SpeechRecognitionType', 'SAFT22kHz8BitStereo',
    'DISPID_SGRSTNextState', 'SPINTERFERENCE_TOOLOUD',
    'SPDATAKEYLOCATION', 'DISPID_SASetState',
    'DISPID_SPIRetainedSizeBytes', 'SpeechPropertyAdaptationOn',
    'DISPID_SRState', 'DISPID_SOTSetId', 'SRARoot',
    'SPTEXTSELECTIONINFO', 'SVEAudioLevel',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRRTStreamTime',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SDKGetStringValue', 'DISPID_SLPSymbolic', 'SpShortcut',
    'LONG_PTR', 'SAFT32kHz8BitStereo', 'SpMemoryStream',
    'DISPID_SVPause', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRCCreateGrammar', 'SVP_0', 'SPAUDIOOPTIONS',
    'SAFT48kHz16BitMono', 'SVSFIsXML', 'SAFT44kHz16BitStereo',
    'DISPID_SGRSAddRuleTransition', 'SVF_Emphasis',
    ...
    'SECFIgnoreCase', 'ISpeechPhraseRules', 'SPVPRI_ALERT',
    'SECNormalConfidence', 'DISPID_SOTMatchesAttributes',
    'ISpeechAudioFormat', 'SP_VISEME_0', 'SpCustomStream',
    'DISPID_SPAs_NewEnum', 'SAFTGSM610_8kHzMono',
    'ISpeechWaveFormatEx', 'SDA_Two_Trailing_Spaces',
    'SPEI_SOUND_START', 'DISPID_SRDisplayUI', 'DISPID_SPIRule',
    'SAFTADPCM_8kHzMono', 'DISPID_SWFEChannels', 'SP_VISEME_19',
    'DISPID_SRCBookmark', 'SECFIgnoreWidth', 'SP_VISEME_4',
    'DISPID_SRGId', 'DISPID_SRCEHypothesis', 'DISPID_SRIsShared',
    'DISPID_SPAsItem', 'DISPID_SWFEBitsPerSample',
    'DISPID_SABufferNotifySize', 'SPEI_SR_RETAINEDAUDIO',
    'ISpPhoneConverter', 'eLEXTYPE_APP', 'SpeechAudioFormatGUIDWave',
    'SAFT22kHz16BitStereo', 'SDKLCurrentConfig', 'SPSHORTCUTPAIR',
    ...
    'DISPID_SpeechGrammarRule', 'DISPID_SVVoice',
    'ISpeechRecoResultTimes', 'SDTDisplayText',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPIStartTime',
    'SGRSTTTextBuffer', 'SAFT8kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SVGetProfiles', 'SPLO_STATIC',
    'DISPID_SPEActualConfidence', 'SAFT24kHz16BitMono',
    'STSF_LocalAppData', 'DISPID_SpeechLexiconWord', 'SPEI_PHONEME',
    'SPAS_PAUSE', 'DISPID_SPPChildren', 'DISPID_SpeechPhraseBuilder',
    'SVSFParseMask', 'DISPID_SAFGuid', 'SVSFParseSapi',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRCEPhraseStart',
    'SAFTADPCM_11kHzMono', 'SpeechEmulationCompareFlags',
    'SAFT24kHz16BitStereo', 'SP_VISEME_12', 'DISPID_SGRSTWeight',
    'SVP_21', 'SpStream', 'DISPID_SGRSTPropertyValue',
    'SGLexicalNoSpecialChars', 'DISPID_SRCVoice',
    'DISPID_SPILanguageId', 'eLEXTYPE_LETTERTOSOUND', 'SPAUDIOSTATE',
    'DISPID_SPRText', 'DISPID_SVSRunningState', 'SDTAlternates',
    'DISPID_SGRAddState', 'ISpRecognizer3', 'eLEXTYPE_PRIVATE3',
    'SpeechRecoEvents', 'SpeechDictationTopicSpelling',
    'DISPID_SPACommit', 'SpObjectToken', 'SVP_19', 'SPPS_Function',
    'SP_VISEME_2', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechDisplayAttributes', 'STCInprocServer', 'SPCS_DISABLED',
    'SAFT12kHz16BitMono', 'SPEI_TTS_PRIVATE',
    'DISPID_SRCEPropertyNumberChange', 'SAFT8kHz8BitStereo',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRCERequestUI',
    'DISPID_SPEDisplayText', 'DISPID_SRRecognizer',
    'SECLowConfidence', 'SVEViseme', 'SpeechStreamSeekPositionType',
    'DISPID_SPRuleName', 'SREBookmark', 'DISPID_SRCEEnginePrivate',
    'SRAONone', 'SRTExtendableParse', 'SPEI_VISEME',
    'ISpeechPhraseElement', 'ISpNotifySource', 'DISPID_SVEStreamEnd',
    'SPEI_RESERVED2', 'SPEI_INTERFERENCE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPIAudioStreamPosition', 'SLOStatic', 'SITooQuiet',
    'SPFM_OPEN_READONLY', 'SPSNoun', 'STSF_AppData',
    'SSSPTRelativeToEnd', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRGetFormat', 'ISpeechObjectTokens',
    'DISPID_SRCEAdaptation', 'SGRSTTWildcard', 'eLEXTYPE_PRIVATE16',
    'SGRSTTWord', 'ISpShortcut', 'SpeechEngineProperties',
    'DISPID_SRStatus', 'DISPID_SPEAudioSizeTime', 'SPSMF_UPS',
    'eLEXTYPE_PRIVATE12', 'SpeechBookmarkOptions', 'SGRSTTEpsilon',
    'DISPID_SPEAudioStreamOffset', 'SP_VISEME_11', 'SPWORDLIST',
    'SPRST_NUM_STATES', 'DISPID_SVEStreamStart', 'SPEI_MAX_TTS',
    'SAFT16kHz8BitStereo', 'SVSFParseSsml', 'SpObjectTokenCategory',
    'ISpeechMMSysAudio', 'SRAImport', 'STCLocalServer',
    'SpeechGrammarWordType', 'DISPID_SpeechLexiconProns',
    'DISPID_SREmulateRecognition', 'SpeechGrammarTagDictation',
    'SPGRAMMARSTATE', 'eLEXTYPE_PRIVATE18', 'DISPID_SPRsItem',
    'SGDSActiveWithAutoPause', 'SASClosed', 'SBOPause',
    'SPXRO_Alternates_SML', 'DISPID_SPEsCount', 'DISPID_SMSGetData',
    'SAFT32kHz8BitMono', 'eLEXTYPE_PRIVATE9', 'SPPS_NotOverriden',
    'SAFT22kHz16BitMono', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVP_16',
    'SAFTGSM610_44kHzMono', 'SDA_No_Trailing_Space',
    'SPEI_TTS_AUDIO_LEVEL', 'SPRS_ACTIVE', 'DISPID_SGRSTText',
    'DISPID_SPPName', 'DISPID_SVGetVoices', 'SPEI_FALSE_RECOGNITION',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPRuleChildren',
    'eLEXTYPE_RESERVED4', 'SREPhraseStart', 'SP_VISEME_21',
    'SWPKnownWordPronounceable', 'DISPID_SRRSpeakAudio',
    'DISPID_SPEPronunciation', 'SSTTDictation',
    'DISPID_SpeechAudioFormat', 'DISPID_SDKDeleteKey',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPRuleConfidence',
    'DISPID_SGRSTs_NewEnum', 'ISpeechRecognizerStatus', 'SASPause',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SPCIdToPhone',
    'DISPID_SVESentenceBoundary', 'DISPID_SOTCDefault',
    'DISPID_SRCERecognition', 'SPCT_DICTATION', 'SP_VISEME_3',
    'SGDSActive', 'SpeechPropertyLowConfidenceThreshold',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRCESoundEnd', 'ISequentialStream',
    'SPAO_RETAIN_AUDIO', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPPsItem', 'ISpeechDataKey', 'DISPID_SRCRequestedUIType',
    'SPINTERFERENCE_LATENCY_WARNING', 'eLEXTYPE_PRIVATE19',
    'DISPID_SABIMinNotification', 'DISPID_SRCPause',
    'IInternetSecurityManager', 'IEnumString',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SBSFormat',
    'SECFNoSpecialChars', 'SPVPRI_NORMAL', 'ISpStreamFormatConverter',
    'SRSInactive', 'ISpRecoContext', 'SPFM_CREATE_ALWAYS',
    'DISPID_SOTsItem', 'SAFT8kHz8BitMono', 'SVP_6', 'SAFTDefault',
    'DISPID_SABIBufferSize', 'SPWT_PRONUNCIATION', 'SpVoice',
    'DISPID_SLWWord', 'DISPID_SpeechPhoneConverter', 'SPBO_PAUSE',
    'SITooLoud', 'SPBOOKMARKOPTIONS', 'SPXRO_SML',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechRecognizer',
    'SpeechRecoContextState', 'SPDKL_LocalMachine',
    'DISPID_SAFSetWaveFormatEx', 'SSFMOpenForRead',
    'DISPID_SRCESoundStart', 'SpPhoneConverter', 'SVP_5',
    'DISPID_SPRulesItem', 'SPPHRASEREPLACEMENT', 'SPSHT_OTHER',
    'SPEI_SOUND_END', 'SPCT_SUB_DICTATION', 'DISPID_SVSPhonemeId',
    'DISPID_SVGetAudioOutputs', 'SWTAdded', 'ISpeechBaseStream',
    'SLODynamic', 'SAFTADPCM_22kHzMono', 'SAFTCCITT_ALaw_44kHzStereo',
    'SSFMCreate', 'DISPID_SPPsCount', 'Speech_Max_Word_Length',
    'DISPID_SOTCId', 'DISPID_SRCEInterference',
    'DISPID_SPEDisplayAttributes', 'ISpStreamFormat',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRGRecoContext',
    'SGDSInactive', 'DISPID_SPRuleParent', 'DISPID_SOTCategory',
    'SPEI_START_SR_STREAM', 'SpeechGrammarTagWildcard',
    'DISPID_SRCState', 'DISPIDSPTSI_ActiveOffset', 'SRSActiveAlways',
    'SP_VISEME_6', 'DISPID_SpeechRecoResultTimes',
    'eLEXTYPE_PRIVATE7', 'SPVPRIORITY', 'DISPID_SPIGetText',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechRecoResult2',
    'SGSDisabled', 'DISPID_SLPs_NewEnum', 'SpeechUserTraining',
    'SPBO_NONE', 'SRTStandard', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPRuleFirstElement', 'DISPID_SPIReplacements',
    'DISPID_SPPs_NewEnum', 'SPPS_Unknown', 'ISpProperties',
    'SP_VISEME_18', 'SpeechRuleAttributes',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_PRIVATE5',
    'SREInterference', 'SPLOADOPTIONS', 'SAFTGSM610_11kHzMono',
    'SpeechDiscardType', 'DISPID_SLPLangId', 'SPFM_NUM_MODES',
    'SPSModifier', 'SPSMF_SRGS_SAPIPROPERTIES', 'SPWF_SRENGINE',
    'SpeechRunState', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPCT_COMMAND', 'DISPID_SGRsItem', 'SPGS_EXCLUSIVE',
    'SPDKL_CurrentUser', 'SpeechCategoryVoices', 'SVP_17',
    'DISPID_SPERetainedSizeBytes', 'SPRST_ACTIVE', 'SP_VISEME_14',
    'DISPID_SVSLastResult', 'DISPID_SpeechLexiconWords', 'SVP_3',
    'DISPID_SpeechVoice', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPIProperties', 'DISPID_SPRules_NewEnum',
    'DISPID_SPAsCount', 'DISPID_SWFEExtraData',
    'DISPID_SRAudioInputStream', 'SpeechAudioVolume',
    'ISpeechCustomStream', 'DISPID_SLGetWords',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_END_SR_STREAM',
    'SSTTTextBuffer', 'SpWaveFormatEx', 'SPSHT_EMAIL',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT12kHz8BitStereo',
    'SPLO_DYNAMIC', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRCEEndStream', 'SPSFunction', 'SAFT11kHz16BitMono',
    'ISpeechMemoryStream', 'SPSNotOverriden',
    'DISPID_SRGDictationSetState', 'SAFTNonStandardFormat',
    '_RemotableHandle', 'SAFTExtendedAudioFormat', 'SRADynamic',
    'SpMMAudioEnum', 'SPSInterjection', 'DISPID_SLWs_NewEnum',
    'DISPID_SVSpeakStream', 'DISPID_SAFType', 'SSFMCreateForWrite',
    'SREAllEvents', 'SpTextSelectionInformation',
    'DISPID_SDKEnumValues', 'SAFTADPCM_44kHzStereo',
    'DISPID_SpeechPhraseReplacement',
    'DISPID_SPERetainedStreamOffset', 'SAFT48kHz8BitMono',
    'SPSHT_Unknown', 'SpeechAudioProperties', 'SREPrivate',
    'SpeechAudioFormatType', 'SPINTERFERENCE', 'SpeechTokenKeyUI',
    'SPEI_MAX_SR', 'SPRST_INACTIVE_WITH_PURGE', 'SLTApp',
    'SpeechTokenKeyAttributes', 'SAFT44kHz16BitMono', 'SPSVerb',
    'SPSSuppressWord', 'SVP_12', '_ISpeechVoiceEvents',
    'SpeechCategoryRecognizers', 'Speech_Default_Weight',
    'SPRECORESULTTIMES', 'DISPID_SRAudioInput', 'SGLexical',
    'DISPID_SpeechFileStream', 'SRERecognition', 'eLEXTYPE_PRIVATE11',
    'SAFT44kHz8BitStereo', 'SpeechLexiconType',
    'DISPID_SDKGetBinaryValue', 'SpeechCategoryAudioOut',
    'SpeechWordPronounceable', 'SpeechVoiceCategoryTTSRate',
    'SpeechCategoryRecoProfiles', 'ISpRecoContext2',
    'DISPID_SVSVisemeId', 'DISPID_SVWaitUntilDone', 'DISPID_SAStatus',
    'DISPID_SPCLangId', 'SPINTERFERENCE_TOOSLOW',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechRecoContext',
    'IStream', 'DISPID_SBSRead', 'SpeechTokenIdUserLexicon', 'STCAll',
    'ISpRecoResult', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SDKOpenKey', 'SAFT16kHz16BitMono', 'SVSFVoiceMask',
    'DISPID_SVSInputSentenceLength', 'ISpeechXMLRecoResult',
    'SpeechMicTraining', 'SpeechRegistryUserRoot', 'SPEI_RECOGNITION',
    'DISPID_SGRsCommitAndSave', 'DISPID_SOTCGetDataKey',
    'SpNotifyTranslator', 'SPEI_UNDEFINED', 'SREStateChange',
    'SPBO_TIME_UNITS', 'SPCONTEXTSTATE',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_WORD_BOUNDARY',
    'SpeechVisemeType', 'DISPID_SpeechMemoryStream', 'SP_VISEME_17',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechVoice',
    'DISPID_SpeechDataKey', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpObjectTokenCategory', 'ISpeechRecognizer', 'DISPID_SOTCSetId',
    'SPCATEGORYTYPE', 'SINoSignal', 'ISpeechObjectTokenCategory',
    'DISPID_SVSInputSentencePosition', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRRAlternates', 'SPWORDPRONUNCIATION',
    'SRADefaultToActive', 'DISPID_SRRSaveToMemory', 'SDTReplacement',
    'DISPID_SVStatus', 'ISpPhoneticAlphabetSelection',
    'ISpeechPhraseElements', 'SP_VISEME_7', 'DISPID_SAVolume',
    'SPDKL_CurrentConfig', 'DISPID_SPIElements', 'DISPID_SRGState',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SVIsUISupported', 'DISPIDSPRG', 'eLEXTYPE_RESERVED9',
    'SPEI_MIN_TTS', 'SPINTERFERENCE_NONE', 'STSF_CommonAppData',
    'SREHypothesis', 'SAFT11kHz8BitStereo', 'SVP_10',
    'SPSEMANTICFORMAT', 'tagSPTEXTSELECTIONINFO', 'SpLexicon',
    'UINT_PTR', 'DISPID_SPPFirstElement',
    'DISPID_SRGetPropertyNumber', 'SREPropertyStringChange',
    'DISPID_SRGSetWordSequenceData', 'SAFT16kHz16BitStereo',
    'SVPNormal', '_SPAUDIOSTATE', 'ISpeechRecoGrammar',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechPhraseRules',
    'SREStreamEnd', 'SPWAVEFORMATTYPE', 'SAFT12kHz8BitMono',
    'SDA_One_Trailing_Space', 'SVF_None', 'ISpeechPhraseAlternates',
    'SSFMOpenReadWrite', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFT24kHz8BitMono', 'DISPID_SpeechPhraseProperty',
    'SVSFIsNotXML', 'SVP_8', 'SpeechLoadOption',
    'SpeechTokenShellFolder', 'ISpeechPhraseInfo',
    'DISPID_SAEventHandle', 'ISpeechAudioBufferInfo',
    'SpeechInterference', 'DISPID_SCSBaseStream', 'SPAR_Medium',
    'DISPID_SPRDisplayAttributes', 'ISpRecoGrammar2',
    'DISPID_SPRuleNumberOfElements', 'SPAR_High',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SDTAudio',
    'ISpeechVoiceStatus', 'DISPID_SPAPhraseInfo',
    'DISPID_SGRSTransitions', 'eLEXTYPE_RESERVED10',
    'DISPID_SGRsFindRule', 'DISPID_SGRSAddSpecialTransition',
    'ISpResourceManager', 'DISPID_SLWType', 'SVEVoiceChange',
    'DISPID_SpeechVoiceEvent', 'DISPID_SWFEAvgBytesPerSec',
    'SP_VISEME_15', 'SGSExclusive', 'DISPID_SGRInitialState',
    'DISPID_SRCEStartStream', 'SVESentenceBoundary',
    'SPEI_PHRASE_START', 'DISPID_SpeechXMLRecoResult',
    'SpeechVoiceEvents', 'eLEXTYPE_VENDORLEXICON',
    'SPFM_OPEN_READWRITE', 'DISPID_SVEAudioLevel', 'SDTProperty',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPIAudioSizeBytes', 'SPSHORTCUTTYPE', 'SVSFIsFilename',
    'DISPID_SGRSTsCount', 'SPRECOSTATE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SLAddPronunciation', 'SAFTCCITT_uLaw_22kHzStereo',
    'SRESoundEnd', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPIGrammarId',
    'SPRECOCONTEXTSTATUS', 'DISPID_SOTIsUISupported', 'SP_VISEME_8',
    'ISpPhoneticAlphabetConverter', 'ISpeechAudioStatus',
    'SRSEIsSpeaking', 'SPINTERFERENCE_NOISE',
    'DISPID_SOTGetDescription', 'SpeechVisemeFeature',
    'DISPID_SLWsCount', 'SPEI_ADAPTATION', 'DISPID_SVSLastBookmark',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPPROPERTYINFO', 'DISPID_SPEs_NewEnum', 'SPAS_CLOSED',
    'SGSEnabled', 'DISPID_SMSADeviceId', 'DISPID_SPELexicalForm',
    'SRCS_Disabled', 'SVSFParseAutodetect', 'SPFILEMODE',
    'DISPID_SVEventInterests', 'DISPID_SDKDeleteValue',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTNoAssignedFormat',
    'SPGRAMMARWORDTYPE', 'SRERecoOtherContext', 'SPGS_DISABLED',
    'SPEI_PROPERTY_NUM_CHANGE', 'SDKLLocalMachine', 'SRSActive',
    'DISPID_SRSClsidEngine', 'DISPID_SRGCmdLoadFromMemory',
    'SREAdaptation', 'DISPID_SpeechLexicon', 'ISpLexicon',
    'SpeechCategoryPhoneConverters', 'DISPID_SRGReset',
    'SGDSActiveUserDelimited', 'SDKLDefaultLocation', 'SpAudioFormat',
    'SAFT44kHz8BitMono', 'SPEVENT', 'SPXMLRESULTOPTIONS',
    'DISPID_SPEEngineConfidence', 'SPPS_RESERVED1',
    'SPSHT_NotOverriden', 'ISpNotifySink',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SOTGetAttribute',
    'DISPID_SASCurrentSeekPosition', 'SPRST_ACTIVE_ALWAYS',
    'eLEXTYPE_PRIVATE13', 'Speech_StreamPos_Asap',
    'DISPID_SRRSetTextFeedback', 'IInternetSecurityMgrSite',
    'DISPID_SGRSRule', 'SpeechFormatType', 'SPCS_ENABLED',
    'SRAExport', 'ISpObjectToken', 'SRCS_Enabled',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRRTTickCount',
    'eLEXTYPE_PRIVATE8', 'SRATopLevel', 'DISPID_SLPPhoneIds',
    'Speech_StreamPos_RealTime', 'SpeechPropertyResponseSpeed',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SMSSetData', 'DISPID_SpeechAudioBufferInfo',
    'SpeechAllElements', 'SPSTREAMFORMATTYPE',
    'ISpeechPhraseProperty', 'DISPID_SVSpeak', 'DISPID_SRCEBookmark',
    'ISpeechLexiconPronunciations', 'DISPID_SpeechAudio',
    'DISPID_SGRSAddWordTransition', 'Speech_Max_Pron_Length',
    'DISPID_SVEPhoneme', 'SPPHRASERULE', 'SpSharedRecognizer',
    'SPAR_Unknown', 'SAFTCCITT_ALaw_22kHzStereo', 'ISpGrammarBuilder',
    'DISPID_SRRGetXMLResult', 'SpSharedRecoContext',
    'SpStreamFormatConverter', 'STSF_FlagCreate', 'SpeechRuleState',
    'SPEI_SR_BOOKMARK', 'DISPID_SRCRetainedAudio', 'DISPID_SBSSeek',
    'DISPID_SOTsCount', 'SVPOver', 'SPDKL_DefaultLocation',
    'DISPID_SRRPhraseInfo', 'SpPhraseInfoBuilder',
    'SWPUnknownWordUnpronounceable', 'DISPID_SOTId',
    'DISPID_SRRAudio', 'DISPID_SRGDictationLoad',
    'DISPID_SDKSetStringValue', 'SITooFast', 'eLEXTYPE_USER',
    'DISPID_SpeechRecoContextEvents', 'SDKLCurrentUser',
    'SPPS_RESERVED3', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SRCResume', 'SPEI_REQUEST_UI', 'SPFM_CREATE',
    'SDTLexicalForm', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SADefaultFormat', 'DISPID_SRGetPropertyString',
    'ISpeechResourceLoader', 'DISPID_SDKGetlongValue', 'SDTRule',
    'DISPID_SpeechObjectTokens', 'DISPID_SpeechPhraseProperties',
    'SVF_Stressed', 'ISpeechRecoResult', 'SPPS_SuppressWord',
    'DISPID_SPIEnginePrivateData', 'eLEXTYPE_PRIVATE17',
    'ISpeechLexiconPronunciation', '_ISpeechRecoContextEvents',
    'SAFTCCITT_uLaw_11kHzStereo', 'SFTInput',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_14',
    'SpeechVoicePriority', 'SLTUser', 'DISPID_SpeechWaveFormatEx',
    'SPRECOGNIZERSTATUS', 'SpeechPropertyComplexResponseSpeed',
    'SPPHRASEELEMENT', 'DISPID_SRGDictationUnload',
    'SpCompressedLexicon', 'SpNullPhoneConverter',
    'ISpeechLexiconWords', 'DISPID_SPRs_NewEnum',
    'eLEXTYPE_RESERVED6', 'SVEBookmark', 'SPPHRASE',
    'SRSInactiveWithPurge', 'SAFTADPCM_8kHzStereo', 'DISPID_SGRName',
    'DISPID_SpeechPhraseAlternate', 'ISpeechPhraseInfoBuilder',
    'SpeechAudioState', 'SREPropertyNumChange', 'DISPID_SOTDataKey',
    'DISPID_SLPsItem', 'SPGS_ENABLED', 'SpeechVoiceSkipTypeSentence',
    'SVSFUnusedFlags', 'DISPID_SWFEBlockAlign',
    'DISPID_SVAlertBoundary', 'DISPID_SRCRecognizer',
    'DISPID_SRRAudioFormat', 'DISPID_SASFreeBufferSpace',
    'SP_VISEME_1', 'DISPID_SRSCurrentStreamNumber',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'eLEXTYPE_RESERVED8',
    'DISPID_SRGSetTextSelection', 'ISpXMLRecoResult',
    'DISPID_SpeechGrammarRules', 'DISPID_SPERequiredConfidence',
    'SpeechEngineConfidence', 'DISPID_SRCSetAdaptationData',
    'SAFT32kHz16BitMono', 'SVSFNLPSpeakPunc', 'SECFDefault',
    'DISPID_SOTs_NewEnum', 'SpFileStream', 'SREAudioLevel',
    'WAVEFORMATEX', 'SpeechGrammarState', 'SPWT_DISPLAY',
    'SPEI_HYPOTHESIS', 'DISPID_SRGetRecognizers',
    'DISPID_SWFESamplesPerSec', 'DISPID_SMSAMMHandle',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVPriority',
    'SpeechRecoProfileProperties', 'SVP_2',
    'DISPID_SRGCmdLoadFromResource', 'SAFTCCITT_uLaw_44kHzMono',
    'SPSEMANTICERRORINFO', 'SpMMAudioIn', 'SpeechTokenValueCLSID',
    'DISPID_SPPEngineConfidence', 'DISPID_SPARecoResult',
    'SPEI_VOICE_CHANGE', 'DISPID_SOTDisplayUI',
    'DISPIDSPTSI_SelectionLength', 'SP_VISEME_13',
    'SpeechCategoryAudioIn', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechPhraseReplacements', 'SAFT16kHz8BitMono',
    'DISPID_SLPType', 'DISPID_SpeechBaseStream',
    'ISpeechRecoResultDispatch', 'DISPID_SVEWord', 'SVP_15',
    'DISPID_SVEBookmark', 'SAFT48kHz16BitStereo', 'SASRun',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPRFirstElement',
    'DISPID_SPRsCount', 'DISPID_SRCreateRecoContext',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SBONone',
    'DISPID_SVSInputWordPosition', 'SpeechRecognizerState',
    'ISpeechFileStream', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SFSOpen', 'SpeechCategoryAppLexicons', 'SPCT_SUB_COMMAND',
    'ISpeechPhoneConverter', 'SpeechPartOfSpeech',
    'DISPID_SGRAttributes', 'SAFTTrueSpeech_8kHz1BitMono', 'SVP_11',
    'DISPID_SRGCmdLoadFromFile', 'SPBINARYGRAMMAR',
    'SpeechSpecialTransitionType', 'DISPID_SPRuleEngineConfidence',
    'SRTReSent', 'DISPID_SGRSTsItem', 'eWORDTYPE_ADDED',
    'DISPID_SVVolume', 'SP_VISEME_9', 'eLEXTYPE_PRIVATE15',
    'ISpeechObjectToken', 'DISPID_SpeechPhraseAlternates',
    'SpeechVoiceSpeakFlags', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPPConfidence', 'SAFTText', 'STCInprocHandler',
    'eLEXTYPE_PRIVATE1', 'eLEXTYPE_RESERVED7', 'DISPID_SVSkip',
    'SPPS_Noncontent', 'SVP_18', 'DISPID_SpeechPhraseRule',
    'DISPID_SABIEventBias', 'DISPID_SVEEnginePrivate',
    'ISpMMSysAudio', 'SPAUDIOBUFFERINFO',
    'SpeechRetainedAudioOptions', 'STCRemoteServer',
    'DISPID_SOTCreateInstance', 'SAFT8kHz16BitMono', 'SP_VISEME_20',
    'SAFT32kHz16BitStereo', '__MIDL_IWinTypes_0009',
    'SpeechStreamFileMode', 'SPSMF_SAPI_PROPERTIES',
    'SPEI_SR_PRIVATE', 'DISPID_SRCCreateResultFromMemory',
    'SVEAllEvents', 'DISPID_SpeechCustomStream', 'SP_VISEME_5',
    'SPEI_END_INPUT_STREAM', 'ISpObjectWithToken', 'DISPID_SPRuleId',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SGRsCommit',
    'eLEXTYPE_MORPHOLOGY', 'SPAS_RUN', 'SPPS_RESERVED4',
    'DISPID_SPRulesCount', 'DISPID_SVAudioOutput', 'SVSFNLPMask',
    'DISPID_SGRsAdd', 'DISPID_SVEVoiceChange', 'SP_VISEME_10',
    'SAFTADPCM_44kHzMono', 'ISpeechGrammarRules', 'SVP_13',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SLPPartOfSpeech', 'SPVPRI_OVER', 'DISPID_SLWLangId',
    'ISpPhraseAlt', 'SPEI_RESERVED1', 'SASStop',
    'SAFT12kHz16BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPPHRASEPROPERTY', 'SPAS_STOP', 'DISPID_SABufferInfo',
    'SVSFPersistXML', 'ISpeechRecoContext', 'SAFT22kHz8BitMono',
    'SPWORDPRONOUNCEABLE', 'tagSPPROPERTYINFO'
]
